...
* v0.0.x: 一些前期开发的版本，不用看
* v0.1.0: 第一个试用版本, 也不用看，后面变更版本号格式了
* v4.0.11_0.1.x: 基于SO库4.0.11，这个版本已经定版了，后续除了bug fix不会有其余API的增减
* v4.0.15_0.2.x: 新增了一些Raw函数, SO库升级到4.0.15，由于API变更所以记作小版本号0.2.0
